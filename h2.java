...
public class h2 extends JFrame
{
	...
	public void his2()
	{
		...
		l2=new JLabel("Jaipur is the capital of India’s Rajasthan state."); 
		l21=new JLabel("It evokes the royal family that once ruled the region and that, in 1727."); 
		l22=new JLabel(" What is now called the Old City or Pink City for its trademark building color");
       // l23=new JLabel("It’s also known for the handicraft shops that line The Mall, a pedestrian avenue, as well as the Lakkar Bazaar.");
        l24=new JLabel("At the center of its stately street grid (notable in India) stands the opulent.");
		l3=new JLabel("UDIAPUR");
		l40=new JLabel("Udaipur, formerly the capital of the Mewar Kingdom, is a city in the western Indian state of Rajasthan.");
        l41=new JLabel("Founded by Maharana Udai Singh II in 1559, it’s set around a series of artificial lakes ."); 
		l42=new JLabel("City Palace, overlooking Lake Pichola, is a monumental complex of 11 palaces,");
        l43=new JLabel("Courtyards and gardens, famed for its intricate");
        //l44=new JLabel("A market specializing in wooden toys and crafts.");
		l5=new JLabel("JAISALMER");
		l6=new JLabel("Jaisalmer is a former medieval trading center and a princely state in the western Indian state of Rajasthan.");   
		l61=new JLabel(" In the heart of the Thar Desert. Known as the Golden City its distinguished by its yellow sandstone architecture. ."); 
		l62=new JLabel("Dominating the skyline is Jaisalmer Fort, a sprawlied by 99 bastions.");
        l63=new JLabel(" Behind its massive walls stand the ornate Maharaja's Palace and intricately carved Jain temples.");
		l7=new JLabel("JODHPUR");
		l8=new JLabel("Jodhpur is a city in the Thar Desert of the northwest Indian state of Rajasthan.");  ;
		l81=new JLabel("Its 15th-century Mehrangarh Fort is a former palace that’s now a museum, displaying weapons,."); 
		l82=new JLabel("Set on on a rocky outcrop, the fort overlooks the walled city. ");
