...
import java.awt.*;
import java.util.*;
public class h4 extends JFrame
{
	public h4(){}
	public h4(String s)
	{
	...
	{
		l1=new JLabel("COORG");
		l2=new JLabel("Madikeri is a hill town in southern India. Framed by the Western Ghats mountain range."); 
		l21=new JLabel("it’s known for the Raja’s Seat, a simple monument overlooking forests and rice paddies."); 
		l22=new JLabel("In the center, the 17th-century Madikeri Fort features 2 stone elephants at the entrance.");
       // l23=new JLabel("It’s also known for the handicraft shops that line The Mall, a pedestrian avenue, as well as the Lakkar Bazaar.");
        l24=new JLabel("The domed Omkareshwar Temple is dedicated to the Hindu deity Shiva.");
		l3=new JLabel("KODAIKANAL");
		l40=new JLabel("Kodaikanal is a hill town in the southern Indian state of Tamil Nadu.");
        l41=new JLabel("It’s set in an area of granite cliffs, forested valleys, lakes, waterfalls and grassy hills."); 
		l42=new JLabel(" At 2,000 meters above sea level, the town centers around man-made, star-shaped Kodaikanal Lake");
        l43=new JLabel("Rowing boats can be hired, and hikers and cyclists follow the 5k Lake Road.");
        //l44=new JLabel("A market specializing in wooden toys and crafts.");
		l5=new JLabel("OOTY");
		l6=new JLabel("Ooty (short for Udhagamandalam) is a resort town in the Western Ghats mountains, in southern India's Tamil Nadu state.");   
		l61=new JLabel("Founded as a British Raj summer resort, it retains a working steam railway line."); 
		l62=new JLabel(" Other reminders of its colonial past include Stone House, a 19th-century. ");
        l63=new JLabel(" Its 55-acre Government Botanical Garden lies on the slopes of Doddabetta Peak. ");
		l7=new JLabel("HAMPI");
		l8=new JLabel("Hampi is an ancient village in the south Indian state of Karnataka.");  ;
		l81=new JLabel("It’s dotted with numerous ruined temple complexes from the Vijayanagara Empire."); 
		l82=new JLabel("On the south bank of the River Tungabhadra is the 7th-century Hindu Virupaksha Temple.");
